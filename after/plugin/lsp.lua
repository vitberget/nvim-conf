...
lsp.on_attach(function(client, bufnr)
	...
	vim.keymap.set("n", "<leader>ci", function() vim.lsp.inlay_hint.enable(true) end, opts)
	vim.keymap.set("n", "<leader>cI", function() vim.lsp.inlay_hint.enable(false) end, opts)
